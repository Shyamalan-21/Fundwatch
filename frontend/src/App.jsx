      ...
      <footer className="bg-slate-950 border-t border-slate-900 py-6 text-xs text-slate-500">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold text-slate-400">FUNDWATCH</span>
            <span>— Explainable MPLADS Spending-Anomaly Detection System</span>
          </div>

          <div className="flex flex-wrap items-center gap-4 text-[11px]">
            <span className="text-slate-400">MoSPI Problem Statement 10</span>
            <span>•</span>
            <span className="text-emerald-400/90 font-mono">MAD Z-Score & IQR Fenced</span>
            <span>•</span>
            <span className="text-sky-400 font-mono">100% Grounded AI Copilot</span>
          </div>
        </div>
      </footer>
    </div>
