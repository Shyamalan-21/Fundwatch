    ...
    <div className="glass-card p-5 border border-slate-800">
      <div className="flex items-center justify-between mb-4 border-b border-slate-800 pb-3">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-[11px] text-slate-400">Decomposition of spending surge vs agency baseline</p>
          </div>
        </div>
        <span className="px-2.5 py-1 rounded-full bg-red-500/10 text-red-400 border border-red-500/20 text-xs font-mono font-bold flex items-center gap-1">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="space-y-3">
          ...
          <div className="p-3.5 rounded-lg bg-slate-950/60 border border-red-900/30">
            <div className="text-[11px] text-red-300 font-medium flex items-center justify-between">
              ...
              <span className="font-mono text-[10px] text-red-400 font-bold">{surgeMultiplier}x Acceleration</span>
            </div>
            <div className="text-lg font-bold font-mono text-red-400 mt-0.5">
              {formatINR(spikeAmount)}
            </div>
            <div className="text-[10px] text-slate-400 mt-1">
              Net surge delta: <span className="font-mono text-red-300 font-semibold">+{formatINR(spikeAmount - baseAmount)}</span>
            </div>
          </div>
        </div>
        ...
        <div className="p-3.5 rounded-lg bg-slate-950/60 border border-slate-800/80 flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between text-[11px] text-slate-300 font-medium mb-2">
              ...
              <span className="text-sky-400 font-mono font-bold">{pctTop3}% in Top {topWorks.length} Works</span>
            </div>
          ...
          <div className="mt-3 pt-2 border-t border-slate-800/80 flex items-center gap-1.5 text-[10px] text-amber-400/90">
